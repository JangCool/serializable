...
public class MsgPackTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("MsgPackTest byte length => " + byteLength);		
		System.out.println("MsgPackTest elapsed => " + (System.currentTimeMillis() - sTime));
